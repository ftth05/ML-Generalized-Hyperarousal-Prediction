...
# https://tex.stackexchange.com/questions/283472/using-latex-font-in-r-computer-modern
  ...
  #quartz()
   s1p1<- ggplot(tmpPP.s1,aes(x=value, y = ..density..))+
    geom_histogram(col=I("black"),fill = "green") + xlim(-1.5,1.5)+
    geom_density(alpha = .5)+    ylab("S1 ") + xlab("")+  theme_bw()+
     theme( plot.title = element_text(hjust = 0.5), # center the plot title
           axis.title.x=element_blank(),
           axis.text.x=element_blank(),
           axis.ticks.x=element_blank(),
           axis.title.y = element_text(size=28, angle=0,vjust=0.5, face='bold.italic'),
   ...
   s1p2<-ggplot(tmpPP.s1, aes(sample=value))+ # scale_x_continuous(limits = c(-4, 4))+
     ylab("") + xlab("")+  theme_bw()+
   ...
   s1p3<- ggplot(tmpHR.s1,aes(x=value, y = ..density..))+
     geom_histogram(col=I("black"),fill = "green") + xlim(-40,40)+
   ...
   s1p5<- ggplot(tmpBR.s1,aes(x=value, y = ..density..))+
     geom_histogram(col=I("black"),fill = "green") +  xlim(-20,20)+
     geom_density(alpha = .5)+    ylab("") + xlab("")+  theme_bw()+
     theme(plot.title = element_text(hjust = 0.5), # center the plot title
           axis.title.x=element_blank(),
           axis.text.x=element_blank(),
...
# O     
  ...
  ggsave(paste0("Figure1_Final.pdf"),
         all,
         device=cairo_pdf,
         width=24,
         height=12,
