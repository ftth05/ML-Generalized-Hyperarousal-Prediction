...
########################################################################
# generate_result_plot(signal="pp")
# generate_result_plot(signal="pp_2")
# generate_result_plot(signal="hr")
# generate_result_plot(signal="br")
# 
# 
# generate_all_subj_plots(signal="pp")
# generate_all_subj_plots(signal="pp_2")
# generate_all_subj_plots(signal="hr")
# generate_all_subj_plots(signal="br")

# # ########################################################################
# # # generate_all_subj_plots(signal="pp", only_test_subjects=T)
# # # generate_all_subj_plots(signal="pp_2", only_test_subjects=T)
# # # generate_all_subj_plots(signal="hr", only_test_subjects=T)
# # # generate_all_subj_plots(signal="br", only_test_subjects=T)
# # ########################################################################
...
########################################################################
# generate_all_subj_plots(signal="pp", windows_size=1)
# generate_all_subj_plots(signal="hr", windows_size=1)
# generate_all_subj_plots(signal="br", windows_size=1)



# generate_all_subj_plots(file_name="data_2.5.csv", windows_size="1", arousal_col_name="Arousal", alpha_val=0.3, signal="pp")
# generate_all_subj_plots(file_name="data_3.csv", windows_size="10", arousal_col_name="Arousal_Mode", alpha_val=0.8, signal="pp")
# 
# generate_all_subj_plots(file_name="data_2.5.csv", windows_size="1", arousal_col_name="Arousal", alpha_val=0.3, signal="hr")
# generate_all_subj_plots(file_name="data_3.csv", windows_size="10", arousal_col_name="Arousal_Mode", alpha_val=0.8, signal="hr")
# 
# generate_all_subj_plots(file_name="data_2.5.csv", windows_size="1", arousal_col_name="Arousal", alpha_val=0.3, signal="br")
# generate_all_subj_plots(file_name="data_3.csv", windows_size="10", arousal_col_name="Arousal_Mode", alpha_val=0.8, signal="br")
# 
# generate_all_subj_plots(file_name="data_2.5.csv", windows_size="1", arousal_col_name="Arousal", alpha_val=0.3, signal="pp_hr_")
# generate_all_subj_plots(file_name="data_3.csv", windows_size="10", arousal_col_name="Arousal_Mode", alpha_val=0.8, signal="pp_hr_")
########################################################################
...
########################################################################
# generate_all_subj_plots <- function(signal, windows_size=10, only_test_subjects=F) {
#   
#   if (windows_size==10) {
#     file_name = "data_3.csv"
#     arousal_col_name = "Arousal_Mode"
...
#       geom_point(alpha = alpha_val) +
#       xlab("Subjects") +
#       ylab(paste0("Time Windows (", windows_size, " sec each)")) +
#       ggtitle(d) +
#       
#       theme_bw() +
#       theme(legend.title = element_blank(),
...
#             axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1, colour=axis_colors)) +
#       guides(colour = guide_legend(override.aes = list(size=6))) +
#       
#       scale_color_manual(values = c("relaxed" = "green",
#                                     "stressed" = "red"))
...
#                          ncol=3)
#   
#   ggsave(paste0("../../../figure/sim1/", signal, "_combined_arousal_", windows_size, "_sec_window", test_subjs, ".pdf"), 
#          grid_plot, 
#          device=cairo_pdf, 
#          
#          #--------- For ncol=2
...
########################################################################
# generate_result_plot <- function(signal) {
#   
#   dat = read.csv(paste0(signal, "_pred_result_df.csv"))
#   # print(signal)
#   # print(head(dat))
...
#   
#   
#   dat$prediction_dot = "True Negative"
#   dat$prediction_dot[dat[, "arousal"]=="stressed" & dat[, "prediction"]=="stressed"] = "True Positive"
#   dat$prediction_dot[dat[, "arousal"]=="stressed" & dat[, "prediction"]=="relaxed"] = "False Negative"
#   dat$prediction_dot[dat[, "arousal"]=="relaxed" & dat[, "prediction"]=="stressed"] = "False Positive"
#   
#   # dat = dat[-which(dat[, "arousal"]==0 & dat[, "prediction"]==0),]
#   # View(dat)
#   
...
#       guides(colour = guide_legend(override.aes = list(size=6))) +
#       # scale_color_manual(values=colors) +
#       scale_color_manual(values = c("True Negative" = "gray81",
#                                     "True Positive" = "green",
#                                     "False Negative" = "red",
...
#                          ncol=2)
# 
#   ggsave(paste0("../../../figure/sim1/", signal, "_combined_arousal_prediction", ".pdf"), 
#          grid_plot, 
#          device=cairo_pdf, 
#          width=16, 
#          height=12)
