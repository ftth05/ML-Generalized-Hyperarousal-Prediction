...
method2 <- method1 + runif(n = 100, min = -0.25, max = 5)
...
rval.ccc01 <- epi.ccc(method1, method2, 
                      ci = "z-transform", 
                      conf.level = 0.95, 
                      rep.measure = FALSE)
...
plot <- ggplot(data = dat.df01, aes(x = method1, y = method2)) + 
  geom_point() +
...
rval.lab02 <- data.frame(lab = paste("CCC: ", 
                                     round(rval.ccc02$rho.c[,1], digits = 2), " (95% CI ", 
                                     round(rval.ccc02$rho.c[,2], digits = 2), " - ",
                                     round(rval.ccc02$rho.c[,3], digits = 2), ")", sep = ""))
...
rval.lab03 <- data.frame(lab = paste("CCC: ", 
                                     round(rval.ccc03$rho.c[,1], digits = 2), " (95% CI ", 
                                     round(rval.ccc03$rho.c[,2], digits = 2), " - ",
                                     round(rval.ccc03$rho.c[,3], digits = 2), ")", sep = ""))
